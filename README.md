...
<a href="https://pkg.go.dev/github.com/matrices/cerca-go"><img src="https://pkg.go.dev/badge/github.com/matrices/cerca-go.svg" alt="Go Reference"></a>

The Cerca Go library provides convenient access to the [Cerca REST API](https://docs.cerca.dev)
...
```sh
go get -u 'github.com/matrices/cerca-go@v0.2.2'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/matrices/cerca-go/option).
...
`*cercago.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `cercago.FileParam(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/matrices/cerca-go/issues) with questions, bugs, or suggestions.
